...
SUBMISSION = os.environ.get("SUBMISSION_FILE", "submission_g7.json")
...
def question_mode(question: str, category: str | None) -> str:
    ...
    known = {"aggregation": "tally", "superlative": "tally", "absence": "absence",
             ...
             "cross-section": "prose", "global_synthesis": "arc",
...
ARC_SYNTHESIS_PROMPT = """Write one final answer to the question below.
...
def answer_question(doc: dict, question: str, category: str | None) -> dict:
    ...
    try:
        if mode == "arc":
            final = call_llm(ARC_SYNTHESIS_PROMPT.format(
